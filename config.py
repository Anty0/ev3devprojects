...
ROBOT_MOTOR_WHEEL_LEFT_GEAR_RATIO = -12 / 36
...
ROBOT_MOTOR_WHEEL_RIGHT_GEAR_RATIO = -12 / 36
...
config_values['TARGET_POWER'] = {
    'display_name': 'Target motor power',
    'type': 'int',
    'default_value': BEACON_FOLLOWER_TARGET_POWER
}
config_values['MAX_SCANNER_POS'] = {
    'display_name': 'Scanner max position',
    'type': 'int',
    'default_value': BEACON_FOLLOWER_MAX_SCANNER_POS
}
BEACON_FOLLOWER_CONFIG_VALUES = config_values
